...
def json_to_nx_struct(data):
    ...
    graph_dict = {'nodes':nodes,'red_nodes':first_set_nodes,'yellow_nodes':second_set_nodes,'edges':weighted_edges,'dir_edges':directed_edges,'undir_edges':undirected_edges,'red_edges':first_set_edges,'yellow_edges':second_set_edges}
    return graph_dict

...
cell_type='Markdown'
cell_string=f"Si consideri la seguente capienza dello zaino:<br/><br/> B={B}<br/><br/>e i seguenti elementi:<br/>{elementi} <br/> che hanno come pesi rispettivamente:<br/>{pesi} <br/> e valori:<br/>{valori} "
cell_metadata={"hide_input": True, "editable": False,  "deletable": False, "tags": ["runcell","noexport"], "trusted": True}
add_cell(cell_type,cell_string,cell_metadata)

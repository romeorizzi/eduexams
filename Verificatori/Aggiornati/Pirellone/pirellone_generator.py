...
def check_numberlight(a,answer,pt_green,pt_red,index_pt):
    ...
    if answer>matrix:
        ...
        return evaluation_format("Si", 0,pt_red,index_pt)+f"La risposta è ammissibile, non posso dirti se è il numero minimo esatto."
...
def check_submatrix(a,answer,pt_green,pt_red,index_pt):
    ...
    if comune:
        ...
        return evaluation_format("Si", pt_green,pt_red,index_pt)+f" Il gruppo di sottomatrici è ammissibile."

...
for i in range (0,len(tasks)):
    ...
    if tasks[i]['request']=="R1":
        ...
        request=f"{num_of_question}. __[{tasks[i]['tot_points']} pts]__ Trovare la massima sottosequenza comune utilizzando: <br/><b>il prefisso</b>  $t'$= {tasks[i]['string_mod']} <br/>$s$={s}."
        ...
        request=f"{num_of_question}. __[{tasks[i]['tot_points']} pts]__ Trovare la massima sottosequenza comune utilizzando:<br/><b>il suffisso </b> $s'$={tasks[i]['string_mod']} <br/>$t$={t}."
        ...
        request=f"{num_of_question}. __[{tasks[i]['tot_points']} pts]__ Trovare la massima sottosequenza comune tale che <b>inizi con la lettera </b> __{tasks[i]['start']}__ utilizzando:<br/>$s$={s}<br/>$t$={t}."
        ...
        request=f"{num_of_question}. __[{tasks[i]['tot_points']} pts]__ Trovare la massima sottosequenza comune tale che <b>finisca con la lettera </b> __{tasks[i]['end']}__ utilizzando:<br/>$s$={s} <br/>$t$={t}."

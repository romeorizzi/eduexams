...
Forniscimi una lista di vertici che formano un ciclo negativo (rispetta la direzione degli archi).
        ...
        verif=f"""
if grafo_conciclo == 1:
    display(Markdown(verifica_ciclo_negativo(griglia1,ciclo_negativo,pt_green=1, pt_red={tasks[i]['tot_points']},index_pt={num_of_question - 1})))
if grafo_conciclo == 2:
    display(Markdown(verifica_ciclo_negativo(griglia2,ciclo_negativo,pt_green=1, pt_red={tasks[i]['tot_points']},index_pt={num_of_question - 1})))"""
...
if grafo_senzaciclo == 1:
    display(Markdown(verifica_presenza_solo_cicli_positivi(griglia1,pesi_nodi,pt_green=1, pt_red={tasks[i]['tot_points']},index_pt={num_of_question - 1})))
if grafo_senzaciclo == 2:
    display(Markdown(verifica_presenza_solo_cicli_positivi(griglia2,pesi_nodi,pt_green=1, pt_red={tasks[i]['tot_points']},index_pt={num_of_question - 1})))"""
    else:
        assert False
    # ( CELL request:
